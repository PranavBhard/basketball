...
from bball_app.core.features.sets import filter_features_by_model_type
from bball_app.core.services.training_data import MASTER_TRAINING_PATH, extract_features_from_master, check_master_needs_regeneration, get_all_possible_features, get_master_training_path
...
class DatasetBuilder:
    ...
    def build_dataset(self, dataset_spec: Dict) -> Dict:
        ...
        if use_master:
            ...
            import pandas as pd
            from bball_app.core.services.training_data import extract_features_from_master
