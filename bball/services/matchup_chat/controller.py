...
from bball.services.matchup_chat.context_repository import SharedContextRepository
from bball.services.matchup_chat.prediction_bootstrap import ensure_shared_context_baseline
from bball.services.matchup_chat.tool_cache import ToolCache
from bball.services.matchup_chat.schemas import (
    AgentAction,
    ControllerOptions,
    HistoryEntry,
    SharedContext,
...
class Controller:
    ...
    def _run_network_agent(
        ...
        *,
        ...
        tools = []
        if agent == "research_media_agent":
            from bball.services.news_tools import get_game_news, get_team_news, get_player_news, web_search
    ...
    def _run_stub_agent(
        ...
        *,
        ...
        if agent == "research_media_agent":
            from bball.services.news_tools import get_game_news, get_team_news
