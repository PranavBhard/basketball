...
Usage:
    python -m bball.pipeline.injuries_pipeline nba
    python -m bball.pipeline.injuries_pipeline cbb --workers 4
    python -m bball.pipeline.injuries_pipeline cbb --season 2024-2025
    python -m bball.pipeline.injuries_pipeline nba --date-range 2024-01-01,2024-01-31
"""
...
Examples:
    ...
    python -m bball.pipeline.injuries_pipeline cbb --workers 4
    python -m bball.pipeline.injuries_pipeline cbb --season 2024-2025
    python -m bball.pipeline.injuries_pipeline nba --date 2024-01-15
    python -m bball.pipeline.injuries_pipeline nba --date-range 2024-01-01,2024-01-31
        """
    )
